...
yum update -y
yum install -y https://github.com/cli/cli/releases/download/v2.14.7/gh_2.14.7_linux_amd64.rpm
...
cat <<EOF > Caddyfile
coder.jpw3.me { reverse_proxy localhost:9000 }
coder.jpw3.me:8001 { reverse_proxy localhost:9001 }
coder.jpw3.me:8002 { reverse_proxy localhost:9002 }
coder.jpw3.me:8003 { reverse_proxy localhost:9003 }
coder.jpw3.me:8004 { reverse_proxy localhost:9004 }
coder.jpw3.me:8005 { reverse_proxy localhost:9005 }
coder.jpw3.me:8006 { reverse_proxy localhost:9006 }
EOF
